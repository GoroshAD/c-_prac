...
big = data[data[' n'] == 100000]
small = data[data[' n'] == 5000]
...
plt.title('Время выполнения от количества потоков (N=100000, M=3000)')
...
plt.title('Время выполнения от количества потоков (N=5000, M=200)')
plt.xlabel('Количество потоков')
plt.ylabel('Время (с)')
plt.grid(True)
...
plt.title('Качество от количества потоков (N=100000, M=3000)')
plt.xlabel('Количество потоков')
plt.ylabel('Качество')
plt.grid(True)
...
plt.title('Качество от количества потоков (N=5000, M=200)')
plt.xlabel('Количество потоков')
plt.ylabel('Качество')
plt.grid(True)
